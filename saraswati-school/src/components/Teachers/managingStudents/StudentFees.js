    ...
    <div style={{display:'inline-flex'}}>
      ...
      <div style={{width:'25rem',border: '1px solid #ccc',margin:'30px 6cm',height:'5cm' }}>
        ...
        <h4 style={{marginLeft:'80px'}}>Create Fees and Update fees of student {batch} </h4>
            ...
            <input type='submit' onClick={()=>{Showfees(null)}} value="ShowFees" className='btn btn-success' style={{marginLeft:'10px', marginTop:'1px', border:'2px solid #ccc',borderRadius:'5px'}}></input>  
            </div>
          ...
          return(
            <tr>
               <th scope="row">{info.StudentId}</th>
                ...
                <td><input type='submit' onClick={updatefees} value="Update Fees" className='btn btn-danger'></input>  </td>
                </tr>
          )
         })}
  </tbody>
